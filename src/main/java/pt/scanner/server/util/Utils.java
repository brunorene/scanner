...
public class Utils
{
	...
	public static final Scalar GRAY = new Scalar(127, 127, 127, 0);
	...
	public static final Float SHOW_RATIO = 0.35f;
	...
	public static void showImage(Mat img, int millsTimeout)
	{
		Size showSize = new Size(FastMath.round(img.arrayWidth() * SHOW_RATIO), FastMath.round(img.arrayHeight() * SHOW_RATIO));
